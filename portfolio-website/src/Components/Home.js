                        ...
                        <LandingContentDiv>
                            ...
                            <TopContentFooterDiv>
                                <IconsContainerDiv>
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="14%" viewBox="0 0 24 24" fill="#E5E5E5" style= {{minWidth:'24px'}}>
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="13%" viewBox="0 0 24 24" fill="#E5E5E5" style= {{minWidth:'22px'}}>
